import 'package:app/profile_2/profile_2_bloc.dart';
...
class ProfileView5 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (context) => Profile2Bloc(
              isCurrentUser: isCurrentUserSelected,
            ),
        child: BlocListener<Profile2Bloc, Profile2State>(
      ...
      return
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            CustomButtonSmall(
              onPressed: () async {
                context.read<Profile2Bloc>().add(SaveProfile2Changes());
